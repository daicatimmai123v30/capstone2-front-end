...
export default function Statistical() {
  ...
  useEffect(async()=>{
    try {
      ...
      const response = await axios.post(`${API_URL}/api/Statistical/all`,{startDate,endDate});
              ...
              <div className="box-body">
                ...
                <div class="row time-statistical">
                  ...
                  <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                    <input type="date" name="startDate" value={startDate.toISOString().split('T')[0]} onChange={onChange}></input>
                  </div>
                  ...
                  <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                    <input type="date" name="endDate" value={endDate.toISOString().split('T')[0]} onChange={onChange}></input>
                  </div>
                </div>
